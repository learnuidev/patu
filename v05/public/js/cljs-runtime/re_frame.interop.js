...
return [(function (){var pred__27632 = cljs.core.instance_QMARK_;
var expr__27633 = reactive_val;
if(cljs.core.truth_((pred__27632.cljs$core$IFn$_invoke$arity$2 ? pred__27632.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__27633) : pred__27632.call(null,reagent.ratom.RAtom,expr__27633)))){
return "ra";
} else {
if(cljs.core.truth_((pred__27632.cljs$core$IFn$_invoke$arity$2 ? pred__27632.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__27633) : pred__27632.call(null,reagent.ratom.RCursor,expr__27633)))){
return "rc";
} else {
if(cljs.core.truth_((pred__27632.cljs$core$IFn$_invoke$arity$2 ? pred__27632.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__27633) : pred__27632.call(null,reagent.ratom.Reaction,expr__27633)))){
return "rx";
} else {
if(cljs.core.truth_((pred__27632.cljs$core$IFn$_invoke$arity$2 ? pred__27632.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__27633) : pred__27632.call(null,reagent.ratom.Track,expr__27633)))){
return "tr";
} else {
return "other";
}
