...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26690 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26690(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26695 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26695(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26706 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26706(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26710 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26710(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26713 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26713(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26714 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26714(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26715 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26715(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26716 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26716(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26717 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26717(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26719 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26719(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26747 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26747(b);
}
});
