...
/** @const */ var kaboom$$module$kaboom$v06 = function(gconf) {
  ...
  function camPos(pos) {
    ...
    {
      var pos$35 = $jscomp$restParams;
      if (pos$35.length > 0) {
        game.cam.pos = vec2$$module$kaboom$v06.apply(null, $jscomp.arrayFromIterable(pos$35));
      }
  ...
  function camScale(scale) {
    ...
    {
      var scale$36 = $jscomp$restParams;
      if (scale$36.length > 0) {
        game.cam.scale = vec2$$module$kaboom$v06.apply(null, $jscomp.arrayFromIterable(scale$36));
      }
  ...
  function add(comps) {
    ...
    /** @const */ var obj = {_id:null, hidden:false, paused:false, use:function(comp) {
      ...
      var $jscomp$loop$47 = {};
      for (var k in comp) {
        $jscomp$loop$47.$jscomp$loop$prop$k$49 = k;
        $jscomp$loop$47: {
          if ($jscomp$loop$47.$jscomp$loop$prop$k$49 === "id" || $jscomp$loop$47.$jscomp$loop$prop$k$49 === "require") {
            break $jscomp$loop$47;
          }
          if (typeof comp[$jscomp$loop$47.$jscomp$loop$prop$k$49] === "function") {
            /** @const */ var func = comp[$jscomp$loop$47.$jscomp$loop$prop$k$49].bind(this, state.components);
            if (COMP_EVENTS.has($jscomp$loop$47.$jscomp$loop$prop$k$49)) {
              this.on($jscomp$loop$47.$jscomp$loop$prop$k$49, func);
              break $jscomp$loop$47;
            } else {
              stateContainer[$jscomp$loop$47.$jscomp$loop$prop$k$49] = func;
            }
          } else {
            stateContainer[$jscomp$loop$47.$jscomp$loop$prop$k$49] = comp[$jscomp$loop$47.$jscomp$loop$prop$k$49];
          }
          if (!this[$jscomp$loop$47.$jscomp$loop$prop$k$49]) {
            Object.defineProperty(this, $jscomp$loop$47.$jscomp$loop$prop$k$49, {get:function($jscomp$loop$47) {
              return function() {
                if (comp.id) {
                  return compStates[comp.id][$jscomp$loop$47.$jscomp$loop$prop$k$49];
                } else {
                  return customState[$jscomp$loop$47.$jscomp$loop$prop$k$49];
                }
              };
            }($jscomp$loop$47), set:function($jscomp$loop$47) {
              return function(val) {
                if (comp.id) {
                  compStates[comp.id][$jscomp$loop$47.$jscomp$loop$prop$k$49] = val;
                } else {
                  customState[$jscomp$loop$47.$jscomp$loop$prop$k$49] = val;
                }
              };
            }($jscomp$loop$47)});
          }
        }
        $jscomp$loop$47 = {$jscomp$loop$prop$k$49:$jscomp$loop$47.$jscomp$loop$prop$k$49};
      }
    }, c:function(id) {
      ...
      }
      {
        ...
        if (events[ev]) {
          events[ev].forEach(function(cb) {
            return cb.call.apply(cb, [$jscomp$this].concat($jscomp.arrayFromIterable(args$37)));
          });
        }
        ...
        if (gEvents) {
          gEvents.forEach(function(e) {
            if ($jscomp$this.is(e.tag)) {
              e.cb.apply(e, [$jscomp$this].concat($jscomp.arrayFromIterable(args$37)));
            }
          });
        }
      }
    ...
    for (var id$jscomp$0 in compStates) {
      /** @const */ var comp$38 = compStates[id$jscomp$0];
      /** @const */ var deps = comp$38.require || [];
  ...
  function pos$jscomp$0(args$jscomp$0) {
    ...
    {
      var args$39 = $jscomp$restParams$jscomp$0;
      return {id:"pos", pos:vec2$$module$kaboom$v06.apply(null, $jscomp.arrayFromIterable(args$39)), move:function(args) {
        var $jscomp$restParams = [];
        for (var $jscomp$restIndex = 0; $jscomp$restIndex < arguments.length; ++$jscomp$restIndex) {
          $jscomp$restParams[$jscomp$restIndex - 0] = arguments[$jscomp$restIndex];
        }
        {
          var args$40 = $jscomp$restParams;
          /** @const */ var p = vec2$$module$kaboom$v06.apply(null, $jscomp.arrayFromIterable(args$40));
          /** @const */ var dx = p.x * dt();
          /** @const */ var dy = p.y * dt();
          this.pos.x += dx;
          this.pos.y += dy;
  ...
  function scale$jscomp$0(args) {
    ...
    {
      var args$41 = $jscomp$restParams;
      if (args$41.length === 0) {
        return scale$jscomp$0(1);
      }
      return {id:"scale", scale:vec2$$module$kaboom$v06.apply(null, $jscomp.arrayFromIterable(args$41))};
    }
  }
  function rotate(r) {
  ...
  function color(args) {
    ...
    }
    {
      ...
      return {id:"color", color:rgba$$module$kaboom$v06.apply(null, $jscomp.arrayFromIterable(args$42))};
    }
  }
  function origin(o) {
  ...
  function addLevel(map, conf) {
    ...
    /** @const */ var level = {offset:function() {
      ...
      }
      {
        ...
        /** @const */ var p = vec2$$module$kaboom$v06.apply(null, $jscomp.arrayFromIterable(args$43));
  ...
  function go(id, args) {
    ...
    }
    {
      ...
      game.on("nextFrame", function() {
        ...
        game.scenes[id].apply(game.scenes, $jscomp.arrayFromIterable(args$44));
        if (gconf.debug) {
          regDebugInput();
        }
      });
  ...
  /** @const */ var get_comp = function(id, defaultVal) {
    return state.components[id] || defaultVal;
  };
    ...
    }
    {
      ...
      if (this.events[ev]) {
        this.events[ev].forEach(function(cb) {
          return cb.apply(null, $jscomp.arrayFromIterable(args$34));
        });
      }
    }
  }, scenes:{}};
  ...
  app.run(function() {
    ...
    if (!game.loaded) {
      ...
      if (progress === 1) {
        ...
        /** @const */ var pos$46 = vec2$$module$kaboom$v06(gfx.width() / 2, gfx.height() / 2).sub(vec2$$module$kaboom$v06(w / 2, h / 2));
        gfx.drawRect(vec2$$module$kaboom$v06(0), gfx.width(), gfx.height(), {color:rgb$$module$kaboom$v06(0, 0, 0)});
        gfx.drawRectStroke(pos$46, w, h, {width:4 / gfx.scale()});
        gfx.drawRect(pos$46, w * progress, h);
      }
    } else {
      try {
