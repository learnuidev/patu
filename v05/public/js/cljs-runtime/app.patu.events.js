...
app.patu.events.key_press_rep = (function app$patu$events$key_press_rep(id,handler){
return app.patu.lib.key_press_rep(new cljs.core.Keyword(null,"game","game",-441523833).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(app.patu.state.game_state)),id,handler);
});
...
app.patu.events.key_down_QMARK_ = (function app$patu$events$key_down_QMARK_(key){
if(cljs.core.vector_QMARK_(key)){
return cljs.core.some(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(app.patu.lib.key_down_QMARK_,new cljs.core.Keyword(null,"game","game",-441523833).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(app.patu.state.game_state))),key);
} else {
return app.patu.lib.key_down_QMARK_(new cljs.core.Keyword(null,"game","game",-441523833).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(app.patu.state.game_state)),key);
}
});
