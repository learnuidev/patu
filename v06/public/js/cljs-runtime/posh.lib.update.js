...
posh.lib.update.update_pull = (function posh$lib$update$update_pull(p__47432,storage_key){
...
var posh_tree = map__47433__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47433__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47433__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__47435 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47435,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47435,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47435,(2),null);
var eid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47435,(3),null);
...
posh.lib.update.update_filter_pull = (function posh$lib$update$update_filter_pull(p__47440,storage_key){
...
var posh_tree = map__47441__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47441__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47441__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__47443 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47443,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47443,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47443,(2),null);
var eid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47443,(3),null);
...
posh.lib.update.update_pull_many = (function posh$lib$update$update_pull_many(p__47446,storage_key){
...
var posh_tree = map__47447__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47447__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47447__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__47449 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47449,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47449,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47449,(2),null);
var eids = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47449,(3),null);
...
posh.lib.update.update_q_with_dbvarmap = (function posh$lib$update$update_q_with_dbvarmap(p__47452,storage_key){
...
var posh_tree = map__47453__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47453__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47453__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));

var vec__47455 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47455,(0),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47455,(1),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47455,(2),null);
...
var poshdbmap = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__47458){
var vec__47459 = p__47458;
var db_sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47459,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47459,(1),null);
return cljs.core.PersistentArrayMap.createAsIfByAssoc([db_sym,posh.lib.db.poshdb__GT_analyze_db(posh_tree,poshdb)]);
}),dbvarmap));
var fixed_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__47462){
var vec__47463 = p__47462;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47463,(0),null);
var arg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47463,(1),null);
...
var G__47467 = cljs.core.first(storage_key);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47467__$1)].join('')));
