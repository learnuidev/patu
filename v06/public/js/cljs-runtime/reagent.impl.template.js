...
var G__26794 = o;
goog.object.set(G__26794,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__26819__delegate = function (args){
...
while (G__26820__i < G__26820__a.length) {G__26820__a[G__26820__i] = arguments[G__26820__i + 0]; ++G__26820__i;}
  args = new cljs.core.IndexedSeq(G__26820__a,0,null);
} 
return G__26819__delegate.call(this,args);};
...
return G__26819__delegate(args);
});
...
var G__26797 = o;
goog.object.set(G__26797,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__26829__i < G__26829__a.length) {G__26829__a[G__26829__i] = arguments[G__26829__i + 0]; ++G__26829__i;}
  args = new cljs.core.IndexedSeq(G__26829__a,0,null);
} 
...
var G__26798 = props;
var G__26798__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26798,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__26798);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26798__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__26799 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26799,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__26799;
}
})(),id_class);
...
var G__26800 = (cljs.core.count(argv) - first_child);
switch (G__26800) {
case (0):
...
var vec__26806 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26806,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26806,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26806,(2),null);
...
var temp__5739__auto___26856 = reagent.impl.util.react_key_from_vec(v);
...
var temp__5739__auto___26858 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___26858 == null)){
} else {
var key_26859 = temp__5739__auto___26858;
...
var temp__5739__auto___26860 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___26860 == null)){
} else {
var key_26861 = temp__5739__auto___26860;
(jsprops.key = key_26861);
}
...
var temp__5739__auto___26869 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___26869 == null)){
} else {
var key_26870 = temp__5739__auto___26869;
(jsprops.key = key_26870);
}
...
var temp__5739__auto___26872 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___26872 == null)){
} else {
var key_26874 = temp__5739__auto___26872;
(jsprops.key = key_26874);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26809_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__26809_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__26810 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26810,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26810,(1),null);
...
break;
default:
var G__26887 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__26888 = compiler;
v = G__26887;
compiler = G__26888;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template26816 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template26816 = (function (opts,id,fn_to_element,meta26817){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template26816.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_26818,meta26817__$1){
var self__ = this;
var _26818__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template26816(self__.opts,self__.id,self__.fn_to_element,meta26817__$1));
}));

(reagent.impl.template.t_reagent$impl$template26816.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_26818){
var self__ = this;
var _26818__$1 = this;
return self__.meta26817;
}));

(reagent.impl.template.t_reagent$impl$template26816.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template26816.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template26816.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template26816.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template26816.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta26817","meta26817",-633949033,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template26816.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template26816.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template26816");

(reagent.impl.template.t_reagent$impl$template26816.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template26816");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template26816.
 */
reagent.impl.template.__GT_t_reagent$impl$template26816 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template26816(opts__$1,id__$1,fn_to_element__$1,meta26817){
return (new reagent.impl.template.t_reagent$impl$template26816(opts__$1,id__$1,fn_to_element__$1,meta26817));
});

}

return (new reagent.impl.template.t_reagent$impl$template26816(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
