...
var clojure$test$check$random$IRandom$rand_long$dyn_48846 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_48846(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_48847 = (function (rng){
var x__4428__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_48847(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_48848 = (function (rng){
var x__4428__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_48848(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_48853 = (function (rng,n){
var x__4428__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_48853(rng,n);
}
});
...
var G__48833 = z;
if(((24) > (function (){var G__48834 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__48834) : clojure.test.check.random.longs.bit_count.call(null,G__48834));
})())){
return clojure.test.check.random.longs.bit_xor(G__48833,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__48833;
}
});
...
var G__48857 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__48858 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__48857;
ret = G__48858;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__48836){
...
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48837__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__48841 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48841,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48841,(1),null);
