goog.provide('app.phaser.pokemon');
goog.require('cljs.core');
goog.require('cljs.reader');
goog.require('reagent.core');
var module$node_modules$Phaser$src$phaser=shadow.js.require("module$node_modules$Phaser$src$phaser", {});
if((typeof app !== 'undefined') && (typeof app.phaser !== 'undefined') && (typeof app.phaser.pokemon !== 'undefined') && (typeof app.phaser.pokemon.app_db !== 'undefined')){
} else {
app.phaser.pokemon.app_db = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"cursors","cursors",396681990),null,new cljs.core.Keyword(null,"player","player",-97687400),null,new cljs.core.Keyword(null,"show-debug?","show-debug?",-1274088080),false], null));
}
if((typeof app !== 'undefined') && (typeof app.phaser !== 'undefined') && (typeof app.phaser.pokemon !== 'undefined') && (typeof app.phaser.pokemon.controls !== 'undefined')){
} else {
app.phaser.pokemon.controls = ({});
}
if((typeof app !== 'undefined') && (typeof app.phaser !== 'undefined') && (typeof app.phaser.pokemon !== 'undefined') && (typeof app.phaser.pokemon.scene !== 'undefined')){
} else {
app.phaser.pokemon.scene = ({});
}
app.phaser.pokemon.preload_BANG_ = (function app$phaser$pokemon$preload_BANG_(){
var this$ = this;
...
(app.phaser.pokemon.scene.preload = app.phaser.pokemon.preload_BANG_);
app.phaser.pokemon.arrows_config = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"font","font",-1506159249),"18px monospace",new cljs.core.Keyword(null,"fill","fill",883462889),"#ffffff",new cljs.core.Keyword(null,"padding","padding",1660304693),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"x","x",2099068185),(20),new cljs.core.Keyword(null,"y","y",-1757859776),(10)], null),new cljs.core.Keyword(null,"backgroundColor","backgroundColor",1738438491),"#000000"], null);
app.phaser.pokemon.create_BANG_ = (function app$phaser$pokemon$create_BANG_(){
var this$ = this;
...
var _ = world_layer.setCollisionByProperty(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"collides","collides",361418723),true], null)));
...
var ___$7 = camera.startFollow(new cljs.core.Keyword(null,"player","player",-97687400).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(app.phaser.pokemon.app_db)));
var cursors = this$.input.keyboard.createCursorKeys();
var ___$8 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(app.phaser.pokemon.app_db,cljs.core.assoc,new cljs.core.Keyword(null,"cursors","cursors",396681990),cursors);
var title = "Arrow keys to move\nPress 'D' to show hitboxes";
var ___$9 = this$.add.text((16),(16),title,cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"font","font",-1506159249),"18px monospace",new cljs.core.Keyword(null,"fill","fill",883462889),"#000000",new cljs.core.Keyword(null,"padding","padding",1660304693),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"x","x",2099068185),(20),new cljs.core.Keyword(null,"y","y",-1757859776),(10)], null),new cljs.core.Keyword(null,"backgroundColor","backgroundColor",1738438491),"#ffffff"], null))).setScrollFactor((0)).setDepth((0));
...
(app.phaser.pokemon.controls.controls = (new Phaser.Cameras.Controls.FixedKeyControl(cljs.core.clj__GT_js(config))));

camera.setBounds((0),(0),map.widthInPixels,map.heightInPixels);

return this$.add.text((16),(16),"Arrows keys to scroll",cljs.core.clj__GT_js(app.phaser.pokemon.arrows_config)).setScrollFactor((0));
});
(app.phaser.pokemon.scene.create = app.phaser.pokemon.create_BANG_);
app.phaser.pokemon.update_BANG_ = (function app$phaser$pokemon$update_BANG_(_time,delta){
var map__26772 = cljs.core.deref(app.phaser.pokemon.app_db);
...
var player = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26772__$1,new cljs.core.Keyword(null,"player","player",-97687400));
var cursors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26772__$1,new cljs.core.Keyword(null,"cursors","cursors",396681990));
var speed = (175);
...
return app.phaser.pokemon.controls.controls.update(delta);
});
(app.phaser.pokemon.scene.update = app.phaser.pokemon.update_BANG_);
app.phaser.pokemon.config = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"type","type",1174270348),Phaser.AUTO,new cljs.core.Keyword(null,"width","width",-384071477),(800),new cljs.core.Keyword(null,"height","height",1025178622),(600),new cljs.core.Keyword(null,"parent","parent",-878878779),"game-container",new cljs.core.Keyword(null,"pixelArt","pixelArt",-636167759),true,new cljs.core.Keyword(null,"physics","physics",-1254209137),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"default","default",-1987822328),"arcade",new cljs.core.Keyword(null,"arcade","arcade",-346009095),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"gravity","gravity",-1815198225),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"y","y",-1757859776),(0)], null)], null)], null),new cljs.core.Keyword(null,"scene","scene",1523800415),app.phaser.pokemon.scene], null);
app.phaser.pokemon.create_game = (function app$phaser$pokemon$create_game(){
return (new Phaser.Game(cljs.core.clj__GT_js(app.phaser.pokemon.config)));
});
app.phaser.pokemon.app = (function app$phaser$pokemon$app(){
return app.phaser.pokemon.create_game();
});

//# sourceMappingURL=app.phaser.pokemon.js.map
