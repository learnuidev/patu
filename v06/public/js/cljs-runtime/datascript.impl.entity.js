...
var G__28435 = db;
var G__28436 = e;
var G__28437 = cljs.core.volatile_BANG_(false);
var G__28438 = cljs.core.volatile_BANG_(cljs.core.PersistentArrayMap.EMPTY);
return (datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4 ? datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4(G__28435,G__28436,G__28437,G__28438) : datascript.impl.entity.__GT_Entity.call(null,G__28435,G__28436,G__28437,G__28438));
} else {
return null;
}
});
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28444_SHARP_,p2__28445_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__28444_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__28445_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
} else {
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28446_SHARP_,p2__28447_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__28446_SHARP_,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__28447_SHARP_));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
if(datascript.db.ref_QMARK_(db,a)){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28452_SHARP_,p2__28453_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__28452_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"e","e",1381269198).cljs$core$IFn$_invoke$arity$1(p2__28453_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
return not_found;
...
var iter__4529__auto__ = (function datascript$impl$entity$js_seq_$_iter__28484(s__28485){
...
var c__4527__auto__ = cljs.core.chunk_first(s__28485__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__28487 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__28486 = (0);
while(true){
if((i__28486 < size__4528__auto__)){
var vec__28500 = cljs.core._nth(c__4527__auto__,i__28486);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28500,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28500,(1),null);
cljs.core.chunk_append(b__28487,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__28799 = (i__28486 + (1));
i__28486 = G__28799;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28487),datascript$impl$entity$js_seq_$_iter__28484(cljs.core.chunk_rest(s__28485__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28487),null);
}
} else {
var vec__28522 = cljs.core.first(s__28485__$2);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28522,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28522,(1),null);
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__28484(cljs.core.rest(s__28485__$2)));
}
} else {
return null;
}
...
var G__28810 = null;
var G__28810__1 = (function (f){
var self__ = this;
var this$ = this;
var seq__28550 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__28551 = null;
var count__28552 = (0);
var i__28553 = (0);
while(true){
if((i__28553 < count__28552)){
var vec__28574 = chunk__28551.cljs$core$IIndexed$_nth$arity$2(null,i__28553);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28574,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28574,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__28816 = seq__28550;
var G__28817 = chunk__28551;
var G__28818 = count__28552;
var G__28819 = (i__28553 + (1));
seq__28550 = G__28816;
chunk__28551 = G__28817;
count__28552 = G__28818;
i__28553 = G__28819;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__28550);
if(temp__5735__auto__){
var seq__28550__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__28550__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__28550__$1);
var G__28822 = cljs.core.chunk_rest(seq__28550__$1);
var G__28823 = c__4556__auto__;
var G__28824 = cljs.core.count(c__4556__auto__);
var G__28825 = (0);
seq__28550 = G__28822;
chunk__28551 = G__28823;
count__28552 = G__28824;
i__28553 = G__28825;
continue;
} else {
var vec__28583 = cljs.core.first(seq__28550__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28583,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28583,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__28830 = cljs.core.next(seq__28550__$1);
var G__28831 = null;
var G__28832 = (0);
var G__28833 = (0);
seq__28550 = G__28830;
chunk__28551 = G__28831;
count__28552 = G__28832;
i__28553 = G__28833;
continue;
}
} else {
...
var G__28810__2 = (function (f,use_as_this){
var self__ = this;
var this$ = this;
var seq__28588 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__28589 = null;
var count__28590 = (0);
var i__28591 = (0);
while(true){
if((i__28591 < count__28590)){
var vec__28618 = chunk__28589.cljs$core$IIndexed$_nth$arity$2(null,i__28591);
...
var G__28845 = seq__28588;
var G__28846 = chunk__28589;
var G__28847 = count__28590;
var G__28848 = (i__28591 + (1));
seq__28588 = G__28845;
chunk__28589 = G__28846;
count__28590 = G__28847;
i__28591 = G__28848;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__28588);
if(temp__5735__auto__){
var seq__28588__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__28588__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__28588__$1);
var G__28849 = cljs.core.chunk_rest(seq__28588__$1);
var G__28850 = c__4556__auto__;
var G__28851 = cljs.core.count(c__4556__auto__);
var G__28852 = (0);
seq__28588 = G__28849;
chunk__28589 = G__28850;
count__28590 = G__28851;
i__28591 = G__28852;
continue;
} else {
var vec__28628 = cljs.core.first(seq__28588__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28628,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28628,(1),null);
f.call(use_as_this,v,a,this$);


var G__28855 = cljs.core.next(seq__28588__$1);
var G__28856 = null;
var G__28857 = (0);
var G__28858 = (0);
seq__28588 = G__28855;
chunk__28589 = G__28856;
count__28590 = G__28857;
i__28591 = G__28858;
continue;
}
} else {
...
G__28810 = function(f,use_as_this){
switch(arguments.length){
case 1:
return G__28810__1.call(this,f);
case 2:
return G__28810__2.call(this,f,use_as_this);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__28810.cljs$core$IFn$_invoke$arity$1 = G__28810__1;
G__28810.cljs$core$IFn$_invoke$arity$2 = G__28810__2;
return G__28810;
})()
);
...
var G__28634 = (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2(this$,attr) : datascript.impl.entity.lookup_entity.call(null,this$,attr));
if(datascript.db.multival_QMARK_(self__.db,attr)){
return datascript.impl.entity.multival__GT_js(G__28634);
} else {
return G__28634;
}
}
...
(datascript.impl.entity.Entity.prototype.call = (function (unused__9542__auto__){
var self__ = this;
var self__ = this;
var G__28686 = (arguments.length - (1));
switch (G__28686) {
case (1):
...
(datascript.impl.entity.Entity.prototype.apply = (function (self__,args28545){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args28545)));
}));
...
var temp__5737__auto__ = (function (){var fexpr__28741 = cljs.core.deref(this$.cache);
return (fexpr__28741.cljs$core$IFn$_invoke$arity$1 ? fexpr__28741.cljs$core$IFn$_invoke$arity$1(attr) : fexpr__28741.call(null,attr));
})();
...
var temp__5735__auto___28920 = cljs.core.not_empty(datascript.db._search(e.db,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [e.eid], null)));
if(cljs.core.truth_(temp__5735__auto___28920)){
var datoms_28924 = temp__5735__auto___28920;
cljs.core.vreset_BANG_(e.cache,datascript.impl.entity.touch_components(e.db,datascript.impl.entity.datoms__GT_cache(e.db,datoms_28924)));
